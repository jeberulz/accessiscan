    ...
    <header className="relative z-10">
      <nav className="flex max-w-7xl md:px-6 mx-auto pt-4 pr-4 pb-4 pl-4 items-center justify-between">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <Link href="/#reports" className="text-sm font-medium text-slate-300 hover:text-white transition-colors">Reports</Link>
      ...
      {mobileMenuOpen && (
        <div className="mx-auto max-w-7xl px-4 md:hidden">
          <div className="space-y-1 rounded-xl border border-white/10 bg-white/5 p-3 backdrop-blur">
            <Link className="block rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/5 transition-colors" href="/#how-it-works">How it works</Link>
            <Link className="block rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/5 transition-colors" href="/#features">Features</Link>
            <Link className="block rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/5 transition-colors" href="/#reports">Reports</Link>
            <Link className="block rounded-lg px-3 py-2 text-sm font-medium text-slate-200 hover:bg-white/5 transition-colors" href="/#pricing">Pricing</Link>
