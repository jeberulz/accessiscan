    ...
    <div className="-mb-8 max-w-7xl md:px-6 mr-auto ml-auto pr-4 pl-4">
      ...
      <div className="mt-8 rounded-3xl border border-emerald-500/30 bg-emerald-500/[0.05] p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button className="bg-white/10 text-slate-200 font-semibold py-4 px-8 rounded-xl border border-white/20 hover:bg-white/20 transition-colors shadow-lg hover:shadow-xl inline-flex items-center justify-center">
