  ...
  return <header className="relative z-10">
      <nav className="flex max-w-7xl md:px-6 mx-auto pt-4 pr-4 pb-4 pl-4 items-center justify-between">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <button className="inline-flex items-center justify-center rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 transition-colors">Start FREE Audit</button>
        </div>
      </nav>
